...
Run this after transform_silver_restaurants has promoted new discoveries.
"""
...
def relink() -> dict:
    """Link new_discovery mentions to their place_id now that they exist in silver_restaurants. Returns summary counts."""
    supabase = get_client()
    ...
    if not mentions:
        print("Nothing to do.")
        return {"linked": 0, "still_missing": 0}
    ...
    return {"linked": linked, "still_missing": still_missing}
