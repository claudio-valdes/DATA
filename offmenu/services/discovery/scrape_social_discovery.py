...
Usage:
    python offmenu/services/discovery/scrape_social_discovery.py --platform tiktok
    python offmenu/services/discovery/scrape_social_discovery.py --platform instagram
    python offmenu/services/discovery/scrape_social_discovery.py --platform both
